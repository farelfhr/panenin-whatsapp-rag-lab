...
| Fase 3 - Database dan RAG | Selesai | Migration, loader/chunker, ingestion, retrieval, answer, dan unit test tersedia |
...
| Fase 6 - Tests dan dokumentasi | Selesai | 21 unit test lulus; typecheck dan build lulus; runbook/checklist/handoff selesai |
